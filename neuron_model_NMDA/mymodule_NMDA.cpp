...
/*
 * There are three scenarios, in which MyModule_NMDA can be loaded by NEST:
 *
...
mynest::MyModule_NMDA mymodule_NMDA_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::MyModule_NMDA::MyModule_NMDA()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::MyModule_NMDA::name( void ) const
{
  return std::string( "my module" ); // Return name of the module
}

const std::string
mynest::MyModule_NMDA::commandstring( void ) const
{
  // Instruct the interpreter to load mymodule_NMDA-init.sli
  return std::string( "(mymodule_NMDA-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::MyModule_NMDA::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */

  nest::kernel().model_manager.register_node_model< iaf_bw_2003_NMDA >(
    "iaf_bw_2003_NMDA" );
